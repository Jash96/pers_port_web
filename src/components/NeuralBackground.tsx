...
export default function NeuralBackground({
  className,
  color = "#22d3ee", // Primary cyan-blue to match new theme
  trailOpacity = 0.08,
  particleCount = 600,
  speed = 1,
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Use the void background color (#030712)
    ...
    // Use window-level mouse tracking so it works even when hovering over content above the canvas
  ...
  return (
    <div ref={containerRef} className={cn("fixed inset-0 w-full h-full overflow-hidden", className)} style={{ background: '#030712' }}>
