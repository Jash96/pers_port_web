# AGENTS.md — Portfolio Redesign Journey
...
- Pasted output from Codex design, Stitch, or other design tools
...
- **2026-05-18** — Cloned repo to Mac, created `redesign` branch, wrote this AGENTS.md. No design brief yet; gathering inspiration and mockups externally before any code changes.
